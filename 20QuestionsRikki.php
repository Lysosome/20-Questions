...
<html>
    ...
    <body>
        <!--Gets response-->
        <div id="newItem">Your object: <input id="newItemBox" type="text"></input></div>
        <div id="newAttribute">What differentiates it from <span class="lastItem"></span>? It is <input id="newAttributeBox" type="text"></input>, but a <span class="lastItem"></span> is not.</div>
		<button id="yesButton">Yes</button>
        <button id="noButton">No</button>
        <button id="submitButton">Submit</button>
		<p id="demo"></p>
        <p id="display"><span style="color:#23CF5F;font-size: 10em; font-family: aktiv, helvetica, sans-serif;">Is it a living thing?</span></p>
		...
		$(function(){
			...
			function successFunction( retData ) {
				...
				$('#display').html("<span style=\"color:#23CF5F;font-size: 10em; font-family: aktiv, helvetica, sans-serif;\">" + displayMessage + "<\/span>");
			}
